...
class DiscountsCalculatorScreen extends StatelessWidget {
  const DiscountsCalculatorScreen({super.key});
                ...
                MaterialButton(
                  onPressed: () {
                    ...
                    controller.setdiscountVoucher(
                        'Discounts ${controller.userInput.value}% OFF');
                  },
                  child: Container(
                    decoration: BoxDecoration(
...
class BuildKeypadButtonWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return GetBuilder<DiscountsController>(builder: (controller) {
      return Padding(
